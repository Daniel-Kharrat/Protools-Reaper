...
reaper.Main_OnCommand(reaper.NamedCommandLookup("_BR_DEC_VOL_ENV_PT_10db"), 0)

--SWS/BR: Decrease selected envelope points by 5 db (volume envelope only)
reaper.Main_OnCommand(reaper.NamedCommandLookup("_BR_DEC_VOL_ENV_PT_5db"), 0)

--SWS/BR: Decrease selected envelope points by 1 db (volume envelope only)
reaper.Main_OnCommand(reaper.NamedCommandLookup("_BR_DEC_VOL_ENV_PT_1db"), 0)
